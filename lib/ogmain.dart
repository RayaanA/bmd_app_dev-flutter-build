  ...
  void _startScan() async {
    ...
    if (Platform.isAndroid) {
      if (await Permission.bluetoothScan
          .request()
          .isGranted && await Permission.bluetoothAdvertise
          .request()
          .isGranted && await Permission.bluetoothConnect
          .request()
          .isGranted) {
        permission = true;
      }
      ...
      if (permission && location == true) {
        ...
        // Use context to open app settings
        if (context != null) {
        ...
        case DeviceConnectionState.connected:
          {
            ...
            flutterReactiveBle.subscribeToCharacteristic(qualifiedCharacteristic)
                ...
                // Access appState through a closure
                final appState = context?.read<MyAppState>();

                // Update the charData here
                appState?.charData = data;

                // Notify listeners that charData has changed
